...
App::uses('SqlserverLegacySource', 'SqlserverLegacy.Model/Datasource');

require_once CAKE . DS . 'Test' . DS . 'Case' . DS . 'Model'. DS . 'models.php';

/**
 * SqlserverLegacyTestDb class
 *
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class SqlserverLegacyTestDb extends SqlserverLegacySource {
...
/**
 * SqlserverLegacyTestModel class
 *
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class SqlserverLegacyTestModel extends CakeTestModel {
 ...
 */
	public $belongsTo = array(
		'SqlserverLegacyClientTestModel' => array(
...
/**
 * SqlserverLegacyClientTestModel class
 *
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class SqlserverLegacyClientTestModel extends CakeTestModel {
...
/**
 * SqlserverLegacyTestResultIterator class
 *
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class SqlserverLegacyTestResultIterator extends ArrayIterator {
 ...
 * @package       Cake.Test.Case.Model.Datasource.Database
 */
class SqlserverLegacyTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		...
		$this->db = new SqlserverLegacyTestDb($this->Dbo->config);
		$this->model = new SqlserverLegacyTestModel();
	}
 ...
 */
	public function testFields() {
		$fields = array(
			'[SqlserverLegacyTestModel].[id] AS [SqlserverLegacyTestModel__id]',
			'[SqlserverLegacyTestModel].[client_id] AS [SqlserverLegacyTestModel__client_id]',
			'[SqlserverLegacyTestModel].[name] AS [SqlserverLegacyTestModel__name]',
			'[SqlserverLegacyTestModel].[login] AS [SqlserverLegacyTestModel__login]',
			'[SqlserverLegacyTestModel].[passwd] AS [SqlserverLegacyTestModel__passwd]',
			'[SqlserverLegacyTestModel].[addr_1] AS [SqlserverLegacyTestModel__addr_1]',
			'[SqlserverLegacyTestModel].[addr_2] AS [SqlserverLegacyTestModel__addr_2]',
			'[SqlserverLegacyTestModel].[zip_code] AS [SqlserverLegacyTestModel__zip_code]',
			'[SqlserverLegacyTestModel].[city] AS [SqlserverLegacyTestModel__city]',
			'[SqlserverLegacyTestModel].[country] AS [SqlserverLegacyTestModel__country]',
			'[SqlserverLegacyTestModel].[phone] AS [SqlserverLegacyTestModel__phone]',
			'[SqlserverLegacyTestModel].[fax] AS [SqlserverLegacyTestModel__fax]',
			'[SqlserverLegacyTestModel].[url] AS [SqlserverLegacyTestModel__url]',
			'[SqlserverLegacyTestModel].[email] AS [SqlserverLegacyTestModel__email]',
			'[SqlserverLegacyTestModel].[comments] AS [SqlserverLegacyTestModel__comments]',
			'CONVERT(VARCHAR(20), [SqlserverLegacyTestModel].[last_login], 20) AS [SqlserverLegacyTestModel__last_login]',
			'[SqlserverLegacyTestModel].[created] AS [SqlserverLegacyTestModel__created]',
			'CONVERT(VARCHAR(20), [SqlserverLegacyTestModel].[updated], 20) AS [SqlserverLegacyTestModel__updated]'
		);
		...
		$result = $this->db->fields($this->model, null, 'SqlserverLegacyTestModel.*');
		$expected = $fields;
		$this->assertEquals($expected, $result);
		...
		$this->db->clearFieldMappings();
		$result = $this->db->fields($this->model, null, array('*', 'SqlserverLegacyClientTestModel.*'));
		$expected = array_merge($fields, array(
			'[SqlserverLegacyClientTestModel].[id] AS [SqlserverLegacyClientTestModel__id]',
			'[SqlserverLegacyClientTestModel].[name] AS [SqlserverLegacyClientTestModel__name]',
			'[SqlserverLegacyClientTestModel].[email] AS [SqlserverLegacyClientTestModel__email]',
			'CONVERT(VARCHAR(20), [SqlserverLegacyClientTestModel].[created], 20) AS [SqlserverLegacyClientTestModel__created]',
			'CONVERT(VARCHAR(20), [SqlserverLegacyClientTestModel].[updated], 20) AS [SqlserverLegacyClientTestModel__updated]'));
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testDistinctWithLimit() {
		$this->db->read($this->model, array(
			'fields' => array('DISTINCT SqlserverLegacyTestModel.city', 'SqlserverLegacyTestModel.country'),
			'limit' => 5
		));
 ...
 */
	public function testDescribe() {
		$SqlserverTableDescription = new SqlserverLegacyTestResultIterator(array(
			(object)array(
				'Default' => '((0))',
				'Field' => 'count',
				'Key' => 0,
 ...
 */
	public function testUpdateAllSyntax() {
		$fields = array('SqlserverLegacyTestModel.client_id' => '[SqlserverLegacyTestModel].[client_id] + 1');
		$conditions = array('SqlserverLegacyTestModel.updated <' => date('2009-01-01 00:00:00'));
		$this->db->update($this->model, $fields, null, $conditions);

		$result = $this->db->getLastQuery();
		$this->assertNotRegExp('/SqlserverLegacyTestModel/', $result);
		$this->assertRegExp('/^UPDATE \[sqlserver_legacy_test_models\]/', $result);
